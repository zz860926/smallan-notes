...
register<bit<10>>(100) ack_rst_cnt;
...
control MyIngress(inout headers hdr,
    ...
    action add_syn_ack_cnt() {
        hash(meta.flowlet_map_index, HashAlgorithm.crc16, (bit<16>)0, { hdr.ipv4.dstAddr }, (bit<32>)100);
    ...
    action add_ack_rst_cnt() {
        hash(meta.flowlet_map_index, HashAlgorithm.crc16, (bit<16>)0, { hdr.ipv4.dstAddr }, (bit<32>)100);
        ack_rst_cnt.read(meta.ack_rst_count, (bit<32>)meta.flowlet_map_index);
        meta.ack_rst_count=meta.ack_rst_count+1;
        ack_rst_cnt.write((bit<32>)meta.flowlet_map_index, meta.ack_rst_count);
    } 
    action drop() {
